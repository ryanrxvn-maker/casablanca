...
const ARQUIVOS = ['manifest.json', 'background.js', 'bridge.js', 'flow-background.js', 'flow-bridge.js', 'flow-content.js', 'stockframe-background.js', 'stockframe-bridge.js', 'heygen-content.js', 'inject.js', 'README.md'];
