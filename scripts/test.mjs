...
const ETAPAS = [
  ...
  { tsc: "lib/stockframe.ts lib/stockframe-smart.ts lib/stockframe.test.ts --outDir .test-tmp --module commonjs --target es2022 --moduleResolution node --skipLibCheck --lib esnext,dom,dom.iterable", run: [".test-tmp/stockframe.test.js", "scripts/test-stockframe-integration.mjs", "scripts/test-stockframe-bridge.mjs"] },
