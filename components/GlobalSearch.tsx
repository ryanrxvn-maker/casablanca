...
const ENTRIES: Entry[] = [
  ...
  { id: 'auto-cortes', group: 'Ferramentas', label: 'Auto Cortes', hint: 'Vídeo longo vira cortes com legenda e headline', href: '/tools/auto-cortes', icon: <IconAutoCortes size={20} />, keywords: ['cortes', 'podcast', 'clipes', 'opus', 'reels', 'shorts', 'tiktok'] },
