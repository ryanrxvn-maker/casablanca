...
const ENTRIES: Entry[] = [
  ...
  { id: 'decupagem-copy', group: 'Ferramentas', label: 'Decupagem Inteligente', hint: 'Decupa seguindo sua copy', href: '/tools/decupagem-copy', icon: <IconDecupageCopy size={20} />, keywords: ['smart decup', 'script', 'roteiro'], adminOnly: true },
