          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 bg-gradient-to-br from-violet/[0.08] via-bg-soft to-bg">
            ...
            <div className="relative z-10 flex items-center justify-center">
              <div
                ...
                style={{ background: 'radial-gradient(circle, rgba(167,139,250,0.45), rgba(200,255,0,0.10) 50%, transparent 75%)', filter: 'blur(14px)', animation: 'lcAura 3s ease-in-out infinite' }}
              />
