...
/**
 * Botao "Continuar com Google" com logo oficial inline.
 *
 * Usado em /login e /register. Auto-signup: quando o usuario ainda nao
 * existe, o provider cria a conta + sessao automaticamente sem exigir
 * codigo de confirmacao (OAuth ja garante que o email foi verificado).
 */
