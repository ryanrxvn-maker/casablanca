...
/**
 * FAB 3D "Como usar" — fixo no canto superior direito, logo abaixo da TopBar
 * (posição pedida pelo dono em 10.07.26), em toda ferramenta que tem guia
 * registrado. Abre o card flutuante com o passo a passo visual.
 *
...
export function ToolGuideFab() {
  ...
  return (
    <>
      <div
        className={
          'guide-fab fixed right-7 top-[92px] z-[54] flex flex-col items-center gap-2 transition-opacity duration-500 ' +
