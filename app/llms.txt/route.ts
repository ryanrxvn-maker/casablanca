...
> Plataforma de automação de edição de vídeo. Decupagem automática, lipsync de avatar (video to video) e legendas em lote — você liga a fila e o estúdio entrega pronto.

## Páginas principais
- [Início](${SITE}/): O que o Auto Edit automatiza e como funciona a fila.
- [Planos e preços](${SITE}/planos): Plano grátis e Premium (R$ 57/mês) com todas as ferramentas. Mensal recorrente ou anual parcelável em até 12×.
