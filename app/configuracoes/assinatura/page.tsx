      ...
      {loading ? (
        ...
        <div className="flex flex-col gap-5">
          ...
          <div
            ...
            style={{
              borderColor: hue + '66',
              background: 'linear-gradient(180deg, rgba(255,255,255,0.025), rgba(0,0,0,0.2)), linear-gradient(180deg,rgb(var(--bg-softer)),var(--card-deep))',
          ...
          <div
            ...
            style={{ background: 'linear-gradient(180deg,#131318,var(--card-deep))' }}
          >
            <h2
